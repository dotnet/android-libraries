This package provides .NET for Android bindings for the Java library `androidx.compose.material:material-ripple-android`.
...
| **Artifact ID** | material-ripple-android |
| **Version** | 1.7.8 |
