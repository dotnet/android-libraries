This package provides .NET for Android bindings for the Java library `com.github.bumptech.glide:avif-integration`.
...
| **Description** | An integration library to support AVIF images in Glide |
