This package provides .NET for Android bindings for the Java library `androidx.compose.animation:animation-graphics-android`.
...
| **Artifact ID** | animation-graphics-android |
| **Version** | 1.7.8 |
