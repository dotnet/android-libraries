This package provides .NET for Android bindings for the Java library `androidx.lifecycle:lifecycle-livedata-core-ktx`.
...
| **Artifact ID** | lifecycle-livedata-core-ktx |
| **Version** | 2.8.7 |
