This package provides .NET for Android bindings for the Java library `androidx.wear.watchface:watchface-complications-data`.
...
| **Artifact ID** | watchface-complications-data |
| **Version** | 1.2.1 |
