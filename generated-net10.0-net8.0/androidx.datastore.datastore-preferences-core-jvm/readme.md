This package provides .NET for Android bindings for the Java library `androidx.datastore:datastore-preferences-core-jvm`.
...
| **Artifact ID** | datastore-preferences-core-jvm |
| **Version** | 1.1.3 |
