This package provides .NET for Android bindings for the Java library `androidx.lifecycle:lifecycle-runtime-ktx-android`.
...
| **Artifact ID** | lifecycle-runtime-ktx-android |
| **Version** | 2.8.7 |
