This package provides .NET for Android bindings for the Java library `androidx.wear.watchface:watchface-complications-rendering`.
...
| **Artifact ID** | watchface-complications-rendering |
| **Version** | 1.2.1 |
