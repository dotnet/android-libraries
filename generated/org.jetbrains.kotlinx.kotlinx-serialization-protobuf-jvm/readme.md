This package provides .NET for Android bindings for the Java library `org.jetbrains.kotlinx:kotlinx-serialization-protobuf-jvm`.
...
| **Artifact ID** | kotlinx-serialization-protobuf-jvm |
| **Version** | 1.7.3 |
