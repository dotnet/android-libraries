This package provides .NET for Android bindings for the Java library `androidx.compose.material:material-icons-extended-android`.
...
| **Artifact ID** | material-icons-extended-android |
| **Version** | 1.7.8 |
