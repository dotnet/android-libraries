This package provides .NET for Android bindings for the Java library `androidx.lifecycle:lifecycle-reactivestreams-ktx`.
...
| **Artifact ID** | lifecycle-reactivestreams-ktx |
| **Version** | 2.8.7 |
