This package provides .NET for Android bindings for the Java library `androidx.compose.foundation:foundation-layout-android`.
...
| **Artifact ID** | foundation-layout-android |
| **Version** | 1.7.8 |
