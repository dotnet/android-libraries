This package provides .NET for Android bindings for the Java library `androidx.wear.watchface:watchface-complications-data-source-ktx`.
...
| **Artifact ID** | watchface-complications-data-source-ktx |
| **Version** | 1.2.1 |
